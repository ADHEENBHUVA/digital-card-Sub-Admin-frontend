...
export default function DigitalCardConfig() {
    ...
    const fetcher = url => axios.get(url, { headers: { Authorization: `Bearer ${localStorage.getItem('subAdminToken')}` } }).then(res => res.data);
    const { data: cardData, error, isLoading } = useSWR(
        import.meta.env.VITE_API_URL + '/api/digital-card/my-card',
        fetcher,
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            console.error("DIGITAL CARD UPDATE ERROR:", error);
